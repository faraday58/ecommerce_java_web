						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<h3>Aplicación E-commerce para el curso JAVA WEB</h3>
									<p>Elaborado por Jorge Armando Rodríguez Vera </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-SHOPPER-CURSO-JAVA</h1>
									<h2>Instructores</h2>
									<p> Julio César Saynez Fabián  </p>
                                                                        <p>  Jorge Alberto Solano Gálvez </p>
