				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Carrito de compras para el curso DGAPA Java WEB del 25 al 30 de Junio</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Plantilla modificada por <span><a target="_blank" href="http://mexiti.com">M.I Jorge Armando Rodríguez Vera</a></span></p>
				</div>
			</div>
		</div>
