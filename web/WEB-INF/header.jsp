					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 55 25 11 07 79</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> jarodriguezvera@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						...
						<div class="btn-group pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
                                                                    ${sessionScope.nombre_moneda} ( ${sessionScope.moneda} )
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li><a href="CambiarMoneda?moneda=MXN">Pesos Mexicanos (MXN)</a></li>
									<li><a href="CambiarMoneda?moneda=EUR">Euro (EUR)</a></li>
                                                                        
									<li><a href="CambiarMoneda?moneda=USD">Dolar Estadounidenses (USD)</a></li>
									<li><a href="CambiarMoneda?moneda=CUP">Peso Cubano (CUP)</a></li>
								</ul>
							</div>
						</div>
					</div>
